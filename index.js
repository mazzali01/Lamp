...
lamp.addEventListener('click', function() {
    ...
    if (html.classList.contains('dark-mode')) {
        logo.setAttribute('src', 'assets/lamp2Bsemfundo.png');
        console.log("teste");
    } else {
        logo.setAttribute('src', 'assets/lamp2semfundo.png');
        console.log("teste");
    }
...
var valorestxt = '<p>Nossos valores incluem a busca constante pela excelência educacional, o compromisso com a acessibilidade, a ênfase na inovação, a promoção da diversidade e inclusão, a responsabilidade social e o apoio ao desenvolvimento pessoal e profissional dos alunos. Esses valores moldam a cultura da plataforma e garantem que ela cumpra sua missão de oferecer educação de qualidade, acessível e enriquecedora, capacitando os alunos a prosperarem em seu percurso educacional e profissional.<p>'
var mvvtxt = '';

missao.addEventListener('click', function() {
    document.getElementById('container-mvv').innerHTML = missaotxt;
    console.log("TESTE");
});

visao.addEventListener('click', function() {
    document.getElementById('container-mvv').innerHTML = visaotxt;
    console.log("TESTE");
});

valores.addEventListener('click', function() {
    document.getElementById('container-mvv').innerHTML = valorestxt;
    console.log("TESTE");
});